namespace MyRooms.Producer.Adapters.Database
{
    public static class Queries
    {
        ...
        public static string GET_HOTELS = @"Select * from Hotel";

        public static string GET_HOTEL_DETAILS = @"
            SELECT h.Name, h.Street, h.ZipCode, h.Country, h.RoomsAvailable, h.RoomsBoocked as RoomsBooked, r.Id, r.Number, r.Status, r.Price as Value FROM Hotel h
                LEFT JOIN Room r ON
                r.Hotel_Id = h.Id 
            WHERE h.Id = @Id
        ";
